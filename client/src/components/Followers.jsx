...
export default function Followers() {
  ...
  return (
    <div className='w-[400px] h-[500px] p-[20px] flex flex-col gap-[20px] rounded-lg bg-black text-white'>
      ...
      <div className='Scroller w-full h-[calc(100%-40px)] flex flex-col overflow-y-auto'>
        {
          ...
          {(userdata.follows  &&  JSON.parse(userdata.follows).includes(value.username) )  ? "Following":  <button className='bg-[#FF6500]'>Follow</button>}
            </div>
